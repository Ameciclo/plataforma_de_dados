...
export const COUNTINGS_SUMMARY_DATA_NEW = `${process.env.API_BASE_URL}/api/cyclist-count`;
export const COUNTINGS_DATA_NEW = `${process.env.API_BASE_URL}/api/cyclists-count-editions`;
export const COUNTINGS_DATA_API = `/api/cyclists-count-editions`;
