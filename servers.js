...
export const COUNTINGS_SUMMARY_DATA_NEW =`http://localhost:3000/api/cyclist-count`
export const COUNTINGS_DATA_NEW =`http://localhost:3000/api/cyclists-count-editions`
