...
export const OBSERVATORY_DATA =`http://localhost:8080/cyclist-infra/relationsByCity`
export const OBSERVATORY_DATA_WAYS =`http://localhost:8080/cyclist-infra/ways`
export const OBSERVATORY_DATA_ALL_WAYS = `http://localhost:8080/cyclist-infra/ways/all-ways`
export const OBSERVATORY_DATA_WAYS_SUMMARY =`http://localhost:8080/cyclist-infra/ways/summary`
export const CITIES_DATA =`http://localhost:8080/cities`
